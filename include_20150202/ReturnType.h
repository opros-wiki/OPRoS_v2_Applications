...
#define	OPROS_SET_PROPERTY_ERROR			0x10000004		//	컴포넌트에서 속성 값을 섲정하지 못하는 경우
...
#define	OPROS_API_NOT_SUPPORTED_ERROR		0x200000103	//	API에서 인터페이스를 지원하지 않는 경우
#define	OPROS_API_EXECUTING				0x200000104	//	현재 API를 수행중인 경우, 예를들어 머니퓰레이터가 초기위치로 이동 중인 경우
