...
#ifndef _OPROS_RAW_OARHIVE_H
#define _OPROS_RAW_OARHIVE_H
...
class raw_oarchive  : public oarchive  {
...
public:
	raw_oarchive(std::ostream *is);
	virtual ~raw_oarchive() {};
	...
	virtual oarchive& save(signed char val);
...
protected:
	...
	virtual oarchive& save_array(signed char *p, const long val);
