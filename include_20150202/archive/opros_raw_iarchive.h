...
#ifndef _OPROS_RAW_IARHIVE_H
#define _OPROS_RAW_IARHIVE_H
...
class raw_iarchive : public iarchive  {
...
public:
	raw_iarchive(std::istream *is);
	virtual ~raw_iarchive() {};
	...
	virtual iarchive& load(signed char &val);
...
protected:
	...
	virtual iarchive& load_array(signed char **s, long &sz);
