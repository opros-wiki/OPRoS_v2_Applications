...
{
	PrintMessage("INFO : ManipulatorComp::onInitialize().\n");
...
{
	PrintMessage("INFO : ManipulatorComp::onStart().\n");
...
{
	PrintMessage("INFO : ManipulatorComp::onStop().\n");
...
{
	PrintMessage("INFO : ManipulatorComp::onReset().\n");
	return lastError = OPROS_SUCCESS;
}

ReturnType ManipulatorComp::onError()
{
	PrintMessage("INFO : ManipulatorComp::onError().\n");
	return lastError = OPROS_SUCCESS;
}

ReturnType ManipulatorComp::onRecover()
{
	PrintMessage("INFO : ManipulatorComp::onRecover().\n");
	return lastError = OPROS_SUCCESS;
}

ReturnType ManipulatorComp::onDestroy()
{
	PrintMessage("INFO : ManipulatorComp::onDestroy().\n");
...
{
	PrintMessage("INFO : ManipulatorComp::onEvent().\n");
	return OPROS_SUCCESS;
}

ReturnType ManipulatorComp::onExecute()
{
	PrintMessage("INFO : ManipulatorComp::onExecute().\n");
	return OPROS_SUCCESS;
}
	
ReturnType ManipulatorComp::onUpdated()
{
	PrintMessage("INFO : ManipulatorComp::onUpdated().\n");
	return OPROS_SUCCESS;
}

ReturnType ManipulatorComp::onPeriodChanged()
{
	PrintMessage("INFO : ManipulatorComp::onPeriodChanged().\n");
	return OPROS_SUCCESS;
}
